...
- 上流ファイルへ適用するpatchは、差分中に上流の表現を含み得るため、モデル本体と同じく再配布条件の確認対象とします。
...
| FAIRINO FR5 | [`FAIR-INNOVATION/frcobot_ros2`](https://github.com/FAIR-INNOVATION/frcobot_ros2) | `60755d44d521a5ad6bee8494cc19522f8801aa20` | 利用可能な宣言を確認できず、package metadataも未確定 | モデルと同モデル由来のpatchは、許諾確認まで外部再配布不可 | [`LICENSE_INFO.yaml`](../../sources/models/fr5/LICENSE_INFO.yaml) |
